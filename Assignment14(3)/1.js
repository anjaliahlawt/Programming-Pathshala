...
//                    <button onclick="deleteCard('card-${i}')">Delete</button>
...
// const addIdElement = (card, id) => {
//   const idElement = document.createElement("p");
//   idElement.innerHTML = id;
//   card.appendChild(idElement);
// };

// const addNameElement = (card, name) => {
//   const nameElement = document.createElement("p");
//   nameElement.innerHTML = name;
//   card.appendChild(nameElement);
// };

const addImage = (card, imageSrc, className) => 
  {
  ...
  const addParaElement = (card, text,className) => 
{
  ...
  const addDeleteButton=(card1,button,className)=>
  {
    ...
    deleteElement.classList.add(className);
    card1.appendChild(deleteElement);
  };
  

const createCard = (parent, { image,name,id,prepTimeMinutes,rating,button}) => {
  const card = document.createElement("div");
  const card1=document.createElement("div");
  card.className = "card";
  card1.id="card1";
  
  addImage(card,image,"i");
  addParaElement(card, name,"tittle");
  addParaElement(card, `Id:${id}`,"identify");
  addParaElement(card,`PrepTimeMinutes:${prepTimeMinutes}`,"prep");
  addParaElement(card,`Rating:${rating}`,"rat");
  addDeleteButton(card,button,"btn");
