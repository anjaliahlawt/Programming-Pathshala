...
//-----------------------------------using for-loop-----------------------------------------------
  ...
  for (let i = 0; i < data.recipes.length; i++) 
    {
      result.push({ name: data.recipes[i].name, cuisine: data.recipes[i].cuisine });
    }
  
  console.log(result);


//-------------------------------without take extra array---------------------------------------

// for (let i = 0; i < data.recipes.length; i++) {
//   let recipe = data.recipes[i];
//   data.recipes[i] = { name: recipe.name, cuisine: recipe.cuisine };
// }
...
//   result.push({name:item.name,cuisine:item.cuisine});
// });
// console.log(result);
...
// const result = data.recipes.map(item=> ({ name: item.name, cuisine: item.cuisine }));
